...
(
    ...
    KEY (`consumer_email`),
    KEY (`consumer_email`, `consumer_password`)
);
...
(
    ...
    `order_use_point`       INT          NULL,
    `order_final_cost`      INT          NOT NULL,
    `order_state`           VARCHAR(20)  NOT NULL DEFAULT 'PAYMENT_PENDING' CHECK (`order_state` IN
                                                                                   ('PAYMENT_PENDING',
                                                                                    'PAYMENT_COMPLETED',
                                                                                    'TRANSIT', 'COMPLETED', 'RETURNED',
                                                                                    'CANCELLED', 'WELCOME',
                                                                                    'PAYMENT_FAILED')),
...
(
    ...
    `order_book_title`        VARCHAR(255) NOT NULL,
...
(
    ...
    `address_general`    VARCHAR(255) NOT NULL,
